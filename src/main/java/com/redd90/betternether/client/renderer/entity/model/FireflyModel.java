...
public class FireflyModel extends AgeableModel<FireflyEntity> {
	...
	@Override
	public void setRotationAngles(FireflyEntity entity, float limbAngle, float limbDistance, float customAngle, float headYaw, float headPitch)
	{
