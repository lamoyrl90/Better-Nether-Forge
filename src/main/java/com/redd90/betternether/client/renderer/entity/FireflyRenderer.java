...
public class FireflyRenderer extends MobRenderer<FireflyEntity, AgeableModel<FireflyEntity>> {
	...
	{
		super(renderManager, new FireflyModel(), 0);
	}
	...
	@Override
	public void render(FireflyEntity entity, float f, float g, MatrixStack matrixStack, IRenderTypeBuffer vertexConsumerProvider, int i)
	{
		...
		boolean bl3 = client.func_238206_b_(entity);
		...
		if (!entity.isSpectator())
		{
			...
			while (var21.hasNext())
			{
				...
				LayerRenderer<FireflyEntity, AgeableModel<FireflyEntity>> feature = (LayerRenderer<FireflyEntity, AgeableModel<FireflyEntity>>) var21.next();
	...
	@Override
	protected int getBlockLight(FireflyEntity entity, BlockPos blockPos)
	{
		return 15;
	}
}
