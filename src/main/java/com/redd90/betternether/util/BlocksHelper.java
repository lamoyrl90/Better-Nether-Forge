...
public class BlocksHelper
{
	...
	{
		return state.isIn(BNTags.Blocks.NETHERRACK);
	}
	
	public static boolean isSoulSand(BlockState state)
	{
		return state.isIn(BNTags.Blocks.SOUL_GROUND);
	}
	...
	public static boolean isNetherGround(BlockState state)
	{
		...
		return state.isIn(BNTags.Blocks.NETHER_GROUND);
	}
	...
	public static boolean isBone(BlockState state)
	{
		...
		return b == Blocks.BONE_BLOCK || b == BNBlocks.BONE_BLOCK.get();
	}
	
	public static boolean isNetherMycelium(BlockState state)
	{
		return state.isIn(BNTags.Blocks.NETHER_MYCELIUM);
	}
	...
	{
		return state.getBlock() instanceof SoulFarmlandBlock;
	}
	...
	{
		return state.isIn(BNTags.Blocks.NYLIUM);
	}
}