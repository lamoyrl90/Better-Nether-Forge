...
public class TorridTerracesBiome extends Biome {
	public TorridTerracesBiome() {
		   super((new Biome.Builder())
				   ...
				   .depth(0.25F).scale(0.1F).temperature(2.0F).downfall(0.0F)
				   ...
				   .func_235098_a_(ImmutableList.of(new Biome.Attributes(0.14F, -0.125F, 0.325F, -0.325F, 0.00F))));
	      ...
	      this.addSpawn(EntityClassification.MONSTER, new Biome.SpawnListEntry(EntityType.ZOMBIFIED_PIGLIN, 40, 1, 2));
