...
public class WartForestBiome extends Biome {
	
	public WartForestBiome() {
		   super((new Biome.Builder())
				   .surfaceBuilder(BNSurfaceBuilders.WART_FOREST, BNSurfaceBuilders.WART_FOREST_CONFIG)
	...
	public void finalizeFeatures() {
		BNBiomeFeatures.addWartSeeds(this, 0.05f);
		...
		BNBiomeFeatures.addSoulLilies(this, 0.2f);
	}
}
