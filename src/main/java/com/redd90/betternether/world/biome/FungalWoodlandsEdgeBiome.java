...
public class FungalWoodlandsEdgeBiome extends Biome {
	public FungalWoodlandsEdgeBiome() {
		   super((new Biome.Builder())
				   .surfaceBuilder(BNSurfaceBuilders.FUNGAL_WOODLANDS_EDGE, SurfaceBuilder.NETHERRACK_CONFIG)
				   ...
				   .func_235098_a_(ImmutableList.of(new Biome.Attributes(-0.345F, 0.501F, -0.0F, 0.0F, -0.093F))));
