...
public class OldRedMushroomStructure extends AbstractScatteredStructure {

	public OldRedMushroomStructure(Codec<StructureFrequencyConfig> codec) {
		super(codec);
	}
	   ...
	   public static class Start extends AbstractBNStructure.Start {
	      ...
	      public void func_230364_a_(ChunkGenerator generator, TemplateManager manager, int chunkx, int chunkz, Biome biome, StructureFrequencyConfig config) {
				...
				for(int t = 0; t < frequency; t++) {
					...
					OldRedMushroomPieces.addPiece(manager, this.components, this.rand, new BlockPos(i, l, j), blockreader);
