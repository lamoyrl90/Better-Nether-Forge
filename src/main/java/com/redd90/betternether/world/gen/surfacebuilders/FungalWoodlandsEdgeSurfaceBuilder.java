...
public class FungalWoodlandsEdgeSurfaceBuilder extends NetherSurfaceBuilder {

	private static BlockState NETHERRACK_MOSS = BNBlocks.NETHERRACK_MOSS.get().getDefaultState();
	private static BlockState NETHER_MYCELIUM = BNBlocks.NETHER_MYCELIUM.get().getDefaultState();
	private static BlockState SOUL_SOIL = Blocks.SOUL_SOIL.getDefaultState();
	private static BlockState SOUL_SAND = Blocks.SOUL_SAND.getDefaultState();
	
	public FungalWoodlandsEdgeSurfaceBuilder(Codec<SurfaceBuilderConfig> p_i232132_1_) {
		super(p_i232132_1_);
