...
public abstract class AbstractBNStructure extends Structure<StructureFrequencyConfig> {

	public AbstractBNStructure(Codec<StructureFrequencyConfig> codec) {
		super(codec);
	}
	
	public Structure.IStartFactory<StructureFrequencyConfig> getStartFactory() {
		return AbstractBNStructure.Start::new;
	}
	...
	public static class Start extends MarginedStructureStart<StructureFrequencyConfig> {
		...
		//Generate
		public void func_230364_a_(ChunkGenerator generator, TemplateManager manager, int chunkx, int chunky, Biome biome, StructureFrequencyConfig config) {
			...
			for(int t = 0; t < frequency; t++) {
				...
				AbstractBNStructurePieces.addPiece(manager, this.components, this.rand, new BlockPos(i, l, j));
