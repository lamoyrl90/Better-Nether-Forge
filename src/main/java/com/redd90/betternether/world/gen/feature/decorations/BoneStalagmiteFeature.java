...
public class BoneStalagmiteFeature extends Feature<NoFeatureConfig> {
	...
	public BoneStalagmiteFeature(Codec<NoFeatureConfig> codec) {
		super(codec);
	}
