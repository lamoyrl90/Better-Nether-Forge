...
public class CityPieces {
	private List<CityBuildingStructure> centers = new ArrayList<CityBuildingStructure>();
	private List<CityBuildingStructure> buildings = new ArrayList<CityBuildingStructure>();
	private List<CityBuildingStructure> roadEnds = new ArrayList<CityBuildingStructure>();
	private List<CityBuildingStructure> total = new ArrayList<CityBuildingStructure>();
	...
	private void addBuildingToList(String name, List<CityBuildingStructure> buildings)
	{
		addBuildingToList(name, 0, buildings);
	}
	
	private void addBuildingToList(String name, int offsetY, List<CityBuildingStructure> buildings)
	{
		CityBuildingStructure building = new CityBuildingStructure("city/" + name, offsetY);
	...
	public List<CityBuildingStructure> getBuildings()
	{
		return total;
	}
}
