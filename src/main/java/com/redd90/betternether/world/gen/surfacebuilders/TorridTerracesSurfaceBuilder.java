...
public class TorridTerracesSurfaceBuilder extends NetherSurfaceBuilder {
	...
	public TorridTerracesSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
		super(codec);
	}
	...
	{
		if (!(stateIn == Blocks.MAGMA_BLOCK.getDefaultState())) {
