...
public class NetherGrassFeature extends ScatteredFeature {

	public NetherGrassFeature(Codec<NoFeatureConfig> codec) {
		super(codec);
		this.blockstate = BNBlocks.NETHER_GRASS.get().getDefaultState();
	}
