...
public class RedMoldFeature extends ScatteredFeature {

	public RedMoldFeature(Codec<NoFeatureConfig> codec) {
		super(codec);
		this.blockstate = BNBlocks.RED_MOLD.get().getDefaultState();
	}
