...
public class BoneGrassFeature extends ScatteredFeature {

	public BoneGrassFeature(Codec<NoFeatureConfig> codec) {
		super(codec);
		this.blockstate = BNBlocks.BONE_GRASS.get().getDefaultState();
	}
