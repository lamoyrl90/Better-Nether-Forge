...
public class BNFloorOreFeatureConfig implements IFeatureConfig {
	   public static final Codec<BNFloorOreFeatureConfig> field_236566_a_ = RecordCodecBuilder.create((p_236568_0_) -> {
		      return p_236568_0_.group(BNFloorOreFeatureConfig.FillerBlockType.field_236571_d_.fieldOf("target").forGetter((p_236570_0_) -> {
		      ...
		      }), Codec.INT.fieldOf("depth").withDefault(4).forGetter((p_236567_0_) -> {
			         return p_236567_0_.size;
			      })).apply(p_236568_0_, BNFloorOreFeatureConfig::new);
		   });
		   public final BNFloorOreFeatureConfig.FillerBlockType target;
		   public final int size;
		   public final BlockState state;
		   public final int depth;

		   public BNFloorOreFeatureConfig(BNFloorOreFeatureConfig.FillerBlockType target, BlockState state, int size, int depth) {
		      this.size = size;
		      this.state = state;
		      this.target = target;
		      this.depth = depth;
		   ...
		   public static enum FillerBlockType implements IStringSerializable, net.minecraftforge.common.IExtensibleEnum {
		      ...
		      public static final Codec<BNFloorOreFeatureConfig.FillerBlockType> field_236571_d_ = IStringSerializable.createEnumCodec(BNFloorOreFeatureConfig.FillerBlockType::values, BNFloorOreFeatureConfig.FillerBlockType::byName);
		      /** maps the filler block type name to the corresponding enum value. */
		      private static final Map<String, BNFloorOreFeatureConfig.FillerBlockType> VALUES_MAP = Arrays.stream(values()).collect(Collectors.toMap(BNFloorOreFeatureConfig.FillerBlockType::getName, (p_236573_0_) -> {
		         return p_236573_0_;
		      }));
		       ...
		       */
		      public static BNFloorOreFeatureConfig.FillerBlockType byName(String nameIn) {
