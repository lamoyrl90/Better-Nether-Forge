...
public class SwelteringSwampSurfaceBuilder extends NetherSurfaceBuilder {
	...
	public SwelteringSwampSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
		super(codec);
	}
	...
	public BlockState genSurfColumn(IChunk world, BlockPos pos, Random random, BlockState stateIn)
	{
		...
		case 0:
			if (validWall(world, pos.down()) && validWall(world, pos.north()) && validWall(world, pos.south()) && validWall(world, pos.east()) && validWall(world, pos.west()))
				...
				return SOUL_SOIL;
		case 1:
			return SOUL_SOIL;//BlocksHelper.setWithoutUpdate(world, pos, Blocks.SOUL_SOIL.getDefaultState());
		case 2:
			return NETHERRACK_MOSS;//BlocksHelper.setWithoutUpdate(world, pos, BlocksRegistry.NETHERRACK_MOSS.get().getDefaultState());
		default:
			return stateIn;
		}
	}
