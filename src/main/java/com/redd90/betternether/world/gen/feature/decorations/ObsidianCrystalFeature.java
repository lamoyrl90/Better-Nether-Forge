...
public class ObsidianCrystalFeature extends Feature<NoFeatureConfig> {

	private static final Block[] PALETTES = new Block[] {
			BNBlocks.OBSIDIAN_GLASS.get(),
			Blocks.OBSIDIAN,
			BNBlocks.BLUE_OBSIDIAN_GLASS.get(),
			BNBlocks.BLUE_OBSIDIAN.get()
	};
	...
	public ObsidianCrystalFeature(Codec<NoFeatureConfig> codec) {
		super(codec);
	}
