...
public class GiantMoldSpore extends BNBlock implements IGrowable
{
	private static final VoxelShape SHAPE = Block.makeCuboidShape(4, 0, 4, 12, 14, 12);
	private static final GiantMoldFeature STRUCTURE = new GiantMoldFeature();
	
	public GiantMoldSpore()
	{
