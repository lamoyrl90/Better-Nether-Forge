...
public class BrownMushroomCapBlock extends BNBlock {
	...
	{
		super(BNBlockProperties.brownMushroom().notSolid());
	}
	...
	public ItemStack getItem(IBlockReader world, BlockPos pos, BlockState state)
	{
		...
		return shape == BrownMushroomShape.BOTTOM || shape == BrownMushroomShape.MIDDLE ? new ItemStack(BNBlocks.MUSHROOM_STEM.get()) : new ItemStack(Items.BROWN_MUSHROOM);
	}
