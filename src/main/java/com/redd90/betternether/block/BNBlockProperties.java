...
public class BNBlockProperties {
	...
	public static final AbstractBlock.Properties MUSHROOM = AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.LIGHT_GRAY).hardnessAndResistance(2.0F, 2.0F).sound(SoundType.FUNGUS);
	public static final AbstractBlock.Properties RED_MUSHROOM = AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.RED).hardnessAndResistance(2.0F, 2.0F).sound(SoundType.FUNGUS);
	public static final AbstractBlock.Properties BROWN_MUSHROOM = AbstractBlock.Properties.create(Material.NETHER_WOOD, MaterialColor.BROWN).hardnessAndResistance(2.0F, 2.0F).sound(SoundType.FUNGUS);
