...
public class RedMushroomCapBlock extends BNBlock {
	...
	public RedMushroomCapBlock() {
		super(BNBlockProperties.redMushroom().notSolid());
	...
	{
		return state.get(SHAPE) == TripleShape.TOP ? new ItemStack(Items.RED_MUSHROOM) : new ItemStack(BNBlocks.MUSHROOM_STEM.get());
	}
