...
public class BNSaplingBlock extends BNBlock implements IGrowable {
	private static final VoxelShape SHAPE = Block.makeCuboidShape(4, 0, 4, 12, 14, 12);
	private Block plant;
	
	public BNSaplingBlock(Block plant, MaterialColor color)
	{
	...
	public BNSaplingBlock(Block plant, DyeColor color)
	{
		super(Block.Properties.create(Material.PLANTS, color)
				.sound(SoundType.CROP)
				.notSolid()
